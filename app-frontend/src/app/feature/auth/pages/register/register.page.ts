...
export class RegisterPage implements OnInit {
  ...
  constructor(private _formBuilder: FormBuilder,
    ...
    this.credentialFormGroup = new FormGroup({
      ...
      password: new FormControl([''], [Validators.required, CustomValidators.hasLowercaseLetters,
        CustomValidators.hasUppercaseLetters,
        CustomValidators.hasNumbers,
        Validators.minLength(6),
]),
      repeatPassword: new FormControl([''], [Validators.required, CustomValidators.matchFields('password', 'repeatPassword'),])
    });
  ...
  allFormsAreValid(): boolean{
    return this.credentialFormGroup.valid && this.personalFormGroup.valid && this.addressFormGroup.valid;
  }
  ...
  register() {
   let  user: User= {id: undefined, ...this.credentialFormGroup.value, ...this.personalFormGroup.value, ...this.addressFormGroup.value}
